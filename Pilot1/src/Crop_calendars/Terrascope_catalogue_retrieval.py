...
def OpenSearch_metadata_retrieval(start,end, geo):
    def getCollectionParameters(ElasticSearchURL, printURL=False):
    ...
    collectionInformation=getCollectionParameters(esOpsURL,printURL=True)
